...
class DownstreamServiceTest {
    ...
    void should_return_correct_downstream_message() {
        ...
        //my-message mesajını gönderecek bir request hazırlıyoruz.
        GetDownstreamMessageRequest expectedRequest = GetDownstreamMessageRequest.newBuilder()
                .setMessage(requestMessage)
                .build();

        //Servisime herhangi bir istek atarsam Bana her türlü SUCCESS versin
        ...
        //Servise gerçekten request atıyorum ve bana "SUCCESS" verdiğini teyit ediyorum.
        assertThat(downstreamService.getDownstreamMessage(requestMessage))
                .isEqualTo(responseMessage);
        //Servisimizin my-message ile çağrıldığını doğruluyoruz.
